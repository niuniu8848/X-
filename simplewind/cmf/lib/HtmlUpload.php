...
class HtmlUpload
{
    ...
    public function upload()
    {
        ...
        $arrFileTypes = [
            ...
            'html' => ['title' => 'Html files', 'extensions' => $uploadSetting['file_types']['html']['extensions']],
        ...
        if($strFileExtension=='jpg' || $strFileExtension=='jpeg' || $strFileExtension=='png' || $strFileExtension=='gif')
        {
            $fileSaveName    = 'user_'.$userId.'_'. $arrData['pid'] . '/images/' .$fileImage->getInfo("name");
            $strSaveFilePath = './upload/' . $fileSaveName; //TODO 测试 windows 下
        }
        elseif ($strFileExtension=='js')
        {
            $fileSaveName    = 'user_'.$userId.'_'. $arrData['pid'] . '/js/' .$fileImage->getInfo("name");
            $strSaveFilePath = './upload/' . $fileSaveName; //TODO 测试 windows 下
        }
        elseif ($strFileExtension=='css')
        {
            $fileSaveName    = 'user_'.$userId.'_'. $arrData['pid'] . '/css/' .$fileImage->getInfo("name");
            $strSaveFilePath = './upload/' . $fileSaveName; //TODO 测试 windows 下
        }
        else
        {
            $fileSaveName    = 'user_'.$userId.'_'. $arrData['pid'] . '/' .$fileImage->getInfo("name");
            $strSaveFilePath = './upload/' . $fileSaveName; //TODO 测试 windows 下
        }
